...
function LeftSide({
  ...
  return (
    <div className="bg-white h-[90%] w-full mt-[-30px] md:mx-4 ">
      <div className="flex flex-col md:p-4 md:pt-0 pt-0 justify-between">
        <h3>Bill</h3>
        <form
          className="flex items-center w-full bg-[hsl(189,41%,95%)] rounded-md border-2 hover:border-[#26c0ab]"
          placeholder="0"
        >
      ...
      <div className="flex flex-col pt-2 md:p-4 gap-2 w-full">
        ...
        <div className="grid grid-cols-3 grid-rows-2 w-full h-full gap-2">
          <div
            ...
            className="bg-[hsl(183,100%,15%)] w-fulll h-[50px] flex justify-center items-center rounded-lg hover:bg-[hsl(172,67%,45%)] focus:bg-[hsl(172,67%,45%)] cursor-pointer"
          >
            5%
          </div>
          <div
            onClick={() => setPercent("10")}
            className="bg-[hsl(183,100%,15%)] w-fulll h-full flex justify-center items-center rounded-lg hover:bg-[hsl(172,67%,45%)] focus:bg-[hsl(172,67%,45%)] cursor-pointer"
          >
            10%
          </div>
          <div
          ...
          <div className="w-fulll h-full flex justify-center items-center rounded-lg">
            <input
              type="number"
              className="w-full h-full text-center focus:outline-none focus:outline-[hsl(172,67%,45%)] rounded-lg"
              placeholder="Custom"
              value={custom}
      ...
      <div className="flex flex-col pt-2 md:p-4 md:pt-0 md:mt-6">
        ...
        <form
          className={`flex items-center w-full  bg-[hsl(189,41%,95%)] rounded-md border-2 ${
